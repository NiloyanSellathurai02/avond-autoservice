              ...
              <div class="col-lg-3 col-5">
                <div class="site_logo">
                  <a class="site_link" href="index.html">
                    <img class="dark_theme_logo" src="assets/images/site_logo/dark_theme_site_logo.svg" alt="Site Logo – ProMotors – Car Service & Detailing Template">
                    <img class="light_theme_logo" src="assets/images/site_logo/light_theme_site_logo.svg" alt="Site Logo – ProMotors – Car Service & Detailing Template">
                  </a>
                </div>
              </div>
                ...
                <nav class="main_menu navbar navbar-expand-lg">
                  <div class="main_menu_inner collapse navbar-collapse justify-content-center" id="main_menu_dropdown">
                    <ul class="main_menu_list unordered_list_center">
                      <li class="dropdown">
                        <a class="nav-link" href="#" id="home_submenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">10+ Home</a>
                        <ul class="dropdown-menu" aria-labelledby="home_submenu">
                          <li><a href="index.html">Repair Service</a></li>
                          <li><a href="home2_online_service.html">Online Service</a></li>
                          <li><a href="home3_tyres.html">Tyres Production</a></li>
                          <li><a href="home4_auto_shop.html">Auto Equipments</a></li>
                          <li><a href="home5_hire_expert.html">Hire Expert</a></li>
                          <li><a href="home6_rims_wheels.html">Rims & Wheels</a></li>
                          <li><a href="home7_master_service.html">Master Service</a></li>
                          <li><a href="home8_service_booking.html">Service Booking</a></li>
                          <li><a href="home9_wash_service.html">Wash Service</a></li>
                          <li><a href="home10_paint_service.html">Paint Service</a></li>
                        </ul>
                      </li>
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="service_submenu">
                          ...
                          <li><a href="service_details.html">Service Details V.1</a></li>
                          <li><a href="service_details_2.html">Service Details V.2</a></li>
                        </ul>
                      </li>
                      <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="shop_submenu">
                          ...
                          <li class="dropdown">
                            <a class="nav-link" href="#" id="deals_submenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                              Current Offers
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="deals_submenu">
                              <li><a href="deals.html">Our Deals</a></li>
                              <li><a href="deals_details.html">Deals Details</a></li>
                            </ul>
                          </li>
                      ...
                      <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="pages_submenu">
                          <li class="dropdown active">
                            <a class="nav-link" href="#" id="about_submenu" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                              About
                            </a>
                          ...
                          <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="blog_submenu">
                              ...
                              <li><a href="blog_details.html">Blog Details V.1</a></li>
                              <li><a href="blog_details_2.html">Blog Details V.2</a></li>
                            </ul>
                          </li>
                ...
                <ul class="header_btns_group unordered_list_end">
                  ...
                  <li>
                    <a class="btn_hotline" href="tel:+8801680636189">
                      <span class="btn_text" data-text="+880 1680 6361 89">+880 1680 6361 89</span>
                    </a>
                  </li>
                </ul>
              </div>
                ...
                <div class="about_content">
                  <div class="section_heading">
                    ...
                    <p class="heading_description mb-0">
                      Non nisi est sit amet facilisis magna etiam. Nibh praesent tristique magna sit amet purus gravida quis. A erat nam at lectus urna duis convallis convallis
                    </p>
                  </div>
                  <div class="progress_item">
                    <h4 class="item_title">Highly Qualified Experts</h4>
                    <div class="progress">
                      <div class="progress_bar rx_width_90 wow animated" role="progressbar" data-wow-duration="1s" data-wow-delay=".4s" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
                  ...
                  <div class="progress_item mb-0">
                    ...
                    <div class="progress">
                      <div class="progress_bar rx_width_98 wow animated" role="progressbar" data-wow-duration="1s" data-wow-delay=".4s" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100">
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-lg-4 col-md-6 col-sm-6">
                <a class="service_pill_item" href="service_details.html">
                  <span class="item_icon">
                    <svg width="50" height="53" viewBox="0 0 50 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M17.989 16.9198C18.4298 16.9198 18.8798 17.0943 19.2104 17.4458L24.5082 22.9241L26 21.3814L19.1257 14.2727C20.6345 11.1347 20.4649 7.26919 18.3882 4.20132C16.353 1.21233 13.0218 -0.260247 9.74147 0.0377745L14.1246 6.49696C14.7256 7.39191 14.5137 8.61029 13.6576 9.23263L8.92011 12.6774C8.05552 13.2989 6.87646 13.0894 6.27549 12.1944L1.88388 5.72649C0.503078 8.82942 0.706511 12.5714 2.73152 15.5603C5.13965 19.1024 9.37784 20.5136 13.1998 19.3829L20.5666 27L22.0661 25.4573L16.7684 19.979C16.0911 19.2768 16.0911 18.147 16.7684 17.4458C17.0998 17.0943 17.5482 16.9198 17.989 16.9198ZM48.2825 37.3754C45.8849 33.8112 41.6359 32.3339 37.7669 33.3778L30.5482 26L29.024 27.5569L33.8719 32.5099C34.5635 33.2185 34.5635 34.3588 33.8719 35.0674C33.5257 35.4212 33.0756 35.5982 32.616 35.5982C32.1659 35.5982 31.7167 35.4212 31.3696 35.0674L26.5234 30.1047L25 31.6704L31.5946 38.4104C29.9769 41.5773 30.0799 45.5236 32.1927 48.6729C34.2354 51.716 37.6284 53.2278 40.9867 52.9722L36.5716 46.3994C35.9665 45.4962 36.1916 44.2763 37.0736 43.6474L41.9475 40.2247C42.8304 39.6055 44.0335 39.8355 44.6472 40.729L49.0528 47.3017C50.4983 44.1967 50.3261 40.4096 48.2825 37.3754Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M23.4928 35.7352C23.1839 36.0883 22.681 36.0883 22.3721 35.7352L17.2323 29.8606C16.9226 29.5066 16.9226 28.9337 17.2323 28.5797L17.5078 28.2648C17.8159 27.9117 18.3188 27.9117 18.6285 28.2648L23.7683 34.1403C24.0772 34.4934 24.0772 35.0682 23.7683 35.4213L23.4928 35.7352Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M21 36.5822L9.31104 49.9421L7.86996 51.5866C7.42042 52.0577 6.91066 52.4123 6.35085 52.6435C5.92675 52.831 5.49417 52.9368 5.05396 52.9732C4.90977 52.991 4.76558 52.9999 4.6129 52.9999C3.43391 53.0079 2.25407 52.5377 1.35499 51.5946C-0.451663 49.7021 -0.451663 46.6435 1.35499 44.7599L15.664 31L21 36.5822Z" fill="#EDEDED"/>
                ...
                <a class="service_pill_item" href="service_details.html">
                  <span class="item_icon">
                    <svg width="25" height="52" viewBox="0 0 25 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M14.521 20.2881L11.6342 36.9322H3.06641L7.94341 20.2881H14.521Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0 6.43709H24.1346V0H0V6.43709Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.6744H24.1346V8.19287H0V10.6744Z" fill="#EDEDED"/>
                ...
                <a class="service_pill_item" href="service_details.html">
                  <span class="item_icon">
                    <svg width="36" height="53" viewBox="0 0 36 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M21.7153 24.3511L20.7189 12.0969L30.2311 24.019L30.7591 24.6824L21.7153 24.3511ZM5.28831 47.2245H29.916V29.2392H5.28831V47.2245ZM35.4002 24.6824L35.2895 24.5461L35.2639 24.5214L20.5146 6.64674L20.1058 6.15283C19.8163 5.89735 19.4331 5.75258 19.0158 5.75258H13.9063V4.50928H5.96106V5.75258H1.70316C0.766422 5.75258 0 6.51049 0 7.45574V51.0217C0 51.9678 0.766422 52.7249 1.70316 52.7249H34.0632C34.9999 52.7249 35.7664 51.9678 35.7664 51.0217V25.7221C35.7664 25.321 35.6301 24.9634 35.4002 24.6824Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M20.5149 6.64589L20.1062 6.15198C20.2773 6.28738 20.4136 6.45855 20.5149 6.64589Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M5.28809 3.65498H14.5848V0H5.28809V3.65498Z" fill="#EDEDED"/>
                ...
                <a class="service_pill_item" href="service_details.html">
                  <span class="item_icon">
                    <svg width="48" height="40" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M32.9904 23.2013H41.7957V20.8595H32.9904V23.2013ZM21.0606 29.1368L24.0573 23.2183H21.0606L27.2933 16.031L24.9856 21.4556L27.8128 21.3874L21.0606 29.1368ZM15.4053 23.2013H12.1778V26.4288H9.83594V23.2013H6.59994V20.8595H9.83594V17.632H12.1778V20.8595H15.4053V23.2013ZM2.19727 39.9178H46.1218V11.7476H2.19727V39.9178Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10.0019H47.8171V6.63818H0V10.0019Z" fill="#EDEDED"/>
                      <path fill-rule="evenodd" clip-rule="evenodd" d="M11.0021 2.55474V5.46714H5.89258V2.55474C5.89258 1.14112 7.0337 0 8.44732 0C9.15413 0 9.7843 0.281021 10.2527 0.749391C10.7125 1.20924 11.0021 1.84793 11.0021 2.55474" fill="#EDEDED"/>
          ...
          <div class="container">
            ...
            <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team_expert_item">
                  <div class="team_expert_image">
                    <img src="assets/images/portfolio/portfolio_img_1.jpg" alt="ProMotors - Car Repair Service">
                  </div>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team_expert_item">
                  <div class="team_expert_image">
                    <img src="assets/images/portfolio/portfolio_img_2.jpg" alt="ProMotors - Car Repair Service">
                  </div>
                  <div class="team_expert_content">
                    <div class="team_expert_title">
                      <h3 class="team_expert_name mb-0">Engine Repair</h3>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team_expert_item">
                  <div class="team_expert_image">
                    <img src="assets/images/portfolio/portfolio_img_3.jpg" alt="ProMotors - Car Repair Service">
                  </div>
                  <div class="team_expert_content">
                    <div class="team_expert_title">
                      <h3 class="team_expert_name mb-0">Engine Repair</h3>
              ...
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team_expert_item">
                  <div class="team_expert_image">
                    <img src="assets/images/portfolio/portfolio_img_4.jpg" alt="ProMotors - Car Repair Service">
                  </div>
                  <div class="team_expert_content">
                    <div class="team_expert_title">
                      <h3 class="team_expert_name mb-0">Engine Repair</h3>
        ...
        <div class="copyright_widget">
          <div class="container">
            <p class="copyright_text text-center mb-0">
              <a href="https://themeforest.net/user/merkulove">Merkulove</a> © <b>ProMotors</b> Template All rights reserved Copyrights 2023
            </p>
          </div>
        </div>
      </footer>
