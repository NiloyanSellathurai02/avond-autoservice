...
<html lang="en" data-bs-theme="dark">
  ...
  <head>
    ...
    <title>Our Services V.1 – ProMotors – Car Service & Detailing Template</title>
      ...
      <main class="page_content">
        ...
        <section class="page_banner" style="background-image: url('assets/images/shapes/tyre_print_3.svg');">
          <div class="container">
            <ul class="breadcrumb_nav unordered_list">
              ...
              <li><a href="service.html">Diensten</a></li>
            </ul>
            <h1 class="page_title wow" data-splitting>Onze Diensten</h1>
          </div>
        </section>
        <!-- Page Banner - End
        ================================================== -->
        ...
        <section class="service_section section_space_lg">
          <div class="container">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service_item">
                  ...
                  <div class="item_content">
                    ...
                    <p>
                      Eget velit aliquet sagittis id consectetur. Elit ut aliquam purus sit amet luctus. Odio eu feugiat pretium nibh ipsum consequat nisl vel
                    </p>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service_item">
                  ...
                  <div class="item_content">
                    ...
                    <p>
                      Etiam erat velit scelerisque in. Posuere morbi leo urna molestie at elementum eu. Placerat in egestas erat imperdiet sed euismod
                    </p>
                    <a class="btn-link" href="service_details.html">
                      <span class="btn_icon"><i class="fa-regular fa-angle-right"></i></span>
                      <span class="btn_text">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service_item">
                  ...
                  <div class="item_content">
                    ...
                    <p>
                      Fermentum posuere urna nec tincidunt praesent. Dignissim enim sit amet venenatis. Lorem ipsum dolor sit amet consectetur
                    </p>
                    <a class="btn-link" href="service_details.html">
                      <span class="btn_icon"><i class="fa-regular fa-angle-right"></i></span>
                      <span class="btn_text">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service_item">
                  ...
                  <div class="item_content">
                    ...
                    <p>
                      At auctor urna nunc id cursus metus. In vitae turpis massa sed. Duis aute irure dolor in reprehenderit in voluptate velit
                    </p>
                    <a class="btn-link" href="service_details.html">
                      <span class="btn_icon"><i class="fa-regular fa-angle-right"></i></span>
                      <span class="btn_text">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="service_item">
                  ...
                  <div class="item_content">
                    ...
                    <p>
                      Fusce id velit ut tortor pretium viverra suspendisse. Ullamcorper malesuada proin libero nunc consequat interdum
                    </p>
                    <a class="btn-link" href="service_details.html">
                      <span class="btn_icon"><i class="fa-regular fa-angle-right"></i></span>
                      <span class="btn_text">
            ...
            <div class="btn_wrap text-center d-md-none d-block">
